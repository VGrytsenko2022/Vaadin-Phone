...
public class PhoneView extends Composite<VerticalLayout> {
    ...
    public PhoneView() {
        ...
        VerticalLayout phoneNumberPadLayout = new VerticalLayout();
        layoutRow.setFlexGrow(1.0, phoneNumberPadLayout);
        phoneNumberPadLayout.setHeightFull();
        phoneNumberPadLayout.setWidth("85%");
        VideoComponent video = new VideoComponent();
        phoneNumberPadLayout.getStyle().set("border", "1px solid DarkOrange");
        phoneNumberPadLayout.setFlexGrow(1.0, video);
        phoneNumberPadLayout.setHorizontalComponentAlignment(FlexComponent.Alignment.CENTER, video);
        ...
        layoutRow.add(phoneNumberPadLayout);
        phoneNumberPadLayout.add(video);
